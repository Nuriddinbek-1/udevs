      ...
      <div className={`container`}>
        ...
        <div className={`lg:hidden`}>
          ...
          <div className="flex justify-between h-[50px]">
            <img src={logo} alt="udev-logo" width={50} />
            <img src={menu} alt="menu icon" width={30} onClick={() => setIsMenuOpen(true)}/>
          </div>
          ...
          <div
            ...
            <div className="flex justify-between">
              <img src={logo} alt="udev-logo" width={50} />
              <img src={close} alt="close icon" width={30} onClick={() => setIsMenuOpen(false)}/>
            </div>

              <ul className={`${navStyle.ul} flex flex-col my-auto text-center text-2xl`}>
                <li>
                  <a href="#ourservices">{t("navbar.li3.0")}</a>
                </li>
                <li>
                  <a href="">{t('navbar.li5')}</a>
                </li>
                <li>
                  <a href="">{t('navbar.li2')}</a>
                </li>
              </ul>
